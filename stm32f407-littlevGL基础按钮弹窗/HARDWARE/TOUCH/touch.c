...
//	}
//	return 0;
	tp_dev.xfac=(float)6180469/100000000;
	tp_dev.yfac=(float)8497724/100000000;//得到y校准参数
	tp_dev.xoff=-4;
	tp_dev.yoff=-18;	
	tp_dev.touchtype=1;//读取触屏类型标记
	if(tp_dev.touchtype)//X,Y方向与屏幕相反
	{
		CMD_RDX=0X90;
		CMD_RDY=0XD0;	 
